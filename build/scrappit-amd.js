...
var scrappit;(function () { 
  if (typeof scrappit === 'undefined') { scrappit = {}; } 
 if (!scrappit.define) { 
    ...
    function newContext(contextName) {
        ...
        resume = function () {
            ...
            if (context.scriptCount <= 0) {
                ...
                //scrappit.require() calls that also do not end up loading scripts could
            ...
            while (defQueue.length) {
                args = defQueue.shift();
                if (args[0] === null) {
                    return req.onError(makeError('mismatch', 'Mismatched anonymous scrappit.define() module: ' + args[args.length - 1]));
                } else {
                    callDefMain(args);
                }
            }
